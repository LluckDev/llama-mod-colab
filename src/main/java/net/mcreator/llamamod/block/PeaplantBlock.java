...
import net.mcreator.llamamod.procedures.PeaplantMobplayerCollidesWithPlantProcedure;
...
public class PeaplantBlock extends LlamaModModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.STEM)
					.hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("peaplant");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PeaplantBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PeasItem.block, (int) (3)));
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				PeaplantMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
