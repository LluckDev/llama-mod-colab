...
import net.mcreator.llamamod.item.StygianDustDustItem;
...
public class StygianDustOreBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:stygian_dust_ore")
	public static final Block block = null;
	public StygianDustOreBlock(LlamaModModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stygian_dust_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StygianDustDustItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("stygian_dust_ore", "stygian_dust_ore", blockAt -> {
