...
public class LlamaStoneBlockBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:llama_stone_block")
	public static final Block block = null;
	public LlamaStoneBlockBlock(LlamaModModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("llama_stone_block");
		}
