...
import net.mcreator.llamamod.item.StygianIronIngotItem;
...
public class StygianIronOreBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:stygian_iron_ore")
	public static final Block block = null;
	public StygianIronOreBlock(LlamaModModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stygian_iron_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StygianIronIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("stygian_iron_ore", "stygian_iron_ore", blockAt -> {
