...
import net.mcreator.llamamod.procedures.LlamagunBulletHitsBlockProcedure;
...
public class LlamagunItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:llamagun")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletllamagun").setRegistryName("entitybulletllamagun"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 100f, 10, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BullitItem.block, (int) (1));
		}
			...
			if (this.inGround) {
				{
					...
					LlamagunBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
