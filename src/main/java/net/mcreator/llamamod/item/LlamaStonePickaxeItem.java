...
public class LlamaStonePickaxeItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:llama_stone_pickaxe")
	public static final Item block = null;
	public LlamaStonePickaxeItem(LlamaModModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("llama_stone_pickaxe"));
	}
}
