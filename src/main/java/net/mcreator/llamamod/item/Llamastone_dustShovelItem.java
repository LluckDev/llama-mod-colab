...
public class Llamastone_dustShovelItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:llamastone_dust_shovel")
	public static final Item block = null;
	public Llamastone_dustShovelItem(LlamaModModElements instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("llamastone_dust_shovel"));
	}
}
